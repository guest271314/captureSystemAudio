async function captureSystemAudio() {
  try {
    ...
    requestNativeScript.set('wait', (ms = 50) => new Promise(resolve => setTimeout(resolve, ms)));
    requestNativeScript.set('dir', await self["showDirectoryPicker" in self ? "showDirectoryPicker" : "chooseFileSystemEntries"]());
